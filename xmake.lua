...
target("targettest")
    ...
    add_files("src/midend/*.cpp")
    add_files("src/analysis/*.cpp")
    add_files("src/optimization/Mem2Reg.cpp","src/optimization/DeadStoreEli.cpp","src/optimization/LIR.cpp", "src/optimization/AAA.cpp","src/optimization/CFGAnalyse.cpp" )
    add_files("src/backend/*.cpp")
